...
public class AutocompleteRequest implements org.apache.thrift.TBase<AutocompleteRequest, AutocompleteRequest._Fields>, java.io.Serializable, Cloneable, Comparable<AutocompleteRequest> {
  ...
  public int hashCode() {
    ...
    boolean present_autocompleteQuery = true && (isSetAutocompleteQuery());
    list.add(present_autocompleteQuery);
    if (present_autocompleteQuery)
      list.add(autocompleteQuery);

    boolean present_searchChoiceId = true && (isSetSearchChoiceId());
    list.add(present_searchChoiceId);
    if (present_searchChoiceId)
      list.add(searchChoiceId);
  ...
  public int compareTo(AutocompleteRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetAutocompleteQuery()).compareTo(other.isSetAutocompleteQuery());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSearchChoiceId()).compareTo(other.isSetSearchChoiceId());
    if (lastComparison != 0) {
      return lastComparison;
    }
        ...
        switch (schemeField.id) {
          ...
          case 61: // EXCLUDE_VARIANT_IDS
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set236 = iprot.readSetBegin();
                struct.excludeVariantIds = new HashSet<String>(2*_set236.size);
                String _elem237;
                for (int _i238 = 0; _i238 < _set236.size; ++_i238)
                {
                  _elem237 = iprot.readString();
                  struct.excludeVariantIds.add(_elem237);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AutocompleteRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.excludeVariantIds != null) {
        oprot.writeFieldBegin(EXCLUDE_VARIANT_IDS_FIELD_DESC);
        {
          ...
          for (String _iter239 : struct.excludeVariantIds)
          {
  ...
  private static class AutocompleteRequestTupleScheme extends TupleScheme<AutocompleteRequest> {
      ...
      if (struct.isSetExcludeVariantIds()) {
        {
          ...
          for (String _iter240 : struct.excludeVariantIds)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, AutocompleteRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TSet _set241 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.excludeVariantIds = new HashSet<String>(2*_set241.size);
          String _elem242;
          for (int _i243 = 0; _i243 < _set241.size; ++_i243)
          {
            _elem242 = iprot.readString();
            struct.excludeVariantIds.add(_elem242);
          }
        }
        struct.setExcludeVariantIdsIsSet(true);
      }
