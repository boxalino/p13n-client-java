...
public class FacetValue implements org.apache.thrift.TBase<FacetValue, FacetValue._Fields>, java.io.Serializable, Cloneable, Comparable<FacetValue> {
  ...
  public int hashCode() {
    ...
    boolean present_rangeFromInclusive = true && (isSetRangeFromInclusive());
    list.add(present_rangeFromInclusive);
    if (present_rangeFromInclusive)
      list.add(rangeFromInclusive);

    boolean present_rangeToExclusive = true && (isSetRangeToExclusive());
    list.add(present_rangeToExclusive);
    if (present_rangeToExclusive)
      list.add(rangeToExclusive);
    ...
    boolean present_selected = true;
    list.add(present_selected);
    if (present_selected)
      list.add(selected);
  ...
  public int compareTo(FacetValue other) {
    ...
    lastComparison = Boolean.valueOf(isSetRangeToExclusive()).compareTo(other.isSetRangeToExclusive());
    if (lastComparison != 0) {
      return lastComparison;
    }
