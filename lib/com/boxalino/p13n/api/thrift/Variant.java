...
public class Variant implements org.apache.thrift.TBase<Variant, Variant._Fields>, java.io.Serializable, Cloneable, Comparable<Variant> {
  ...
  public List<SearchResult> semanticFilteringResults; // required
  ...
  public Variant(
    ...
    List<SearchResult> semanticFilteringResults)
  {
    this();
  ...
  public Variant(Variant other) {
    ...
    if (other.isSetSemanticFilteringResults()) {
      List<SearchResult> __this__semanticFilteringResults = new ArrayList<SearchResult>(other.semanticFilteringResults.size());
  ...
  public void addToSemanticFilteringResults(SearchResult elem) {
    if (this.semanticFilteringResults == null) {
      this.semanticFilteringResults = new ArrayList<SearchResult>();
    }
    this.semanticFilteringResults.add(elem);
  }

  public List<SearchResult> getSemanticFilteringResults() {
    return this.semanticFilteringResults;
  }

  public Variant setSemanticFilteringResults(List<SearchResult> semanticFilteringResults) {
    this.semanticFilteringResults = semanticFilteringResults;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SEMANTIC_FILTERING_RESULTS:
      if (value == null) {
        ...
        setSemanticFilteringResults((List<SearchResult>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    boolean present_variantId = true && (isSetVariantId());
    list.add(present_variantId);
    if (present_variantId)
      list.add(variantId);

    boolean present_scenarioId = true && (isSetScenarioId());
    list.add(present_scenarioId);
    if (present_scenarioId)
      list.add(scenarioId);

    boolean present_searchResult = true && (isSetSearchResult());
    list.add(present_searchResult);
    if (present_searchResult)
      list.add(searchResult);

    boolean present_searchResultTitle = true && (isSetSearchResultTitle());
    list.add(present_searchResultTitle);
    if (present_searchResultTitle)
      list.add(searchResultTitle);

    boolean present_searchRelaxation = true && (isSetSearchRelaxation());
    list.add(present_searchRelaxation);
    if (present_searchRelaxation)
      list.add(searchRelaxation);

    boolean present_semanticFilteringResults = true && (isSetSemanticFilteringResults());
    list.add(present_semanticFilteringResults);
    if (present_semanticFilteringResults)
      list.add(semanticFilteringResults);
  ...
  public int compareTo(Variant other) {
    ...
    lastComparison = Boolean.valueOf(isSetSemanticFilteringResults()).compareTo(other.isSetSemanticFilteringResults());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.semanticFilteringResults = new ArrayList<SearchResult>(_list180.size);
                SearchResult _elem181;
                for (int _i182 = 0; _i182 < _list180.size; ++_i182)
                {
                  _elem181 = new SearchResult();
                  _elem181.read(iprot);
                  struct.semanticFilteringResults.add(_elem181);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Variant struct) throws org.apache.thrift.TException {
      ...
      if (struct.semanticFilteringResults != null) {
        oprot.writeFieldBegin(SEMANTIC_FILTERING_RESULTS_FIELD_DESC);
        {
          ...
          for (SearchResult _iter183 : struct.semanticFilteringResults)
          {
      ...
      if (struct.isSetSemanticFilteringResults()) {
        {
          ...
          for (SearchResult _iter184 : struct.semanticFilteringResults)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.semanticFilteringResults = new ArrayList<SearchResult>(_list185.size);
          SearchResult _elem186;
          for (int _i187 = 0; _i187 < _list185.size; ++_i187)
          {
            _elem186 = new SearchResult();
            _elem186.read(iprot);
            struct.semanticFilteringResults.add(_elem186);
          }
        }
        struct.setSemanticFilteringResultsIsSet(true);
      }
