...
public class ChoiceRequest implements org.apache.thrift.TBase<ChoiceRequest, ChoiceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<ChoiceRequest> {
  ...
  public ChoiceRequest(ChoiceRequest other) {
    ...
    if (other.isSetInquiries()) {
      List<ChoiceInquiry> __this__inquiries = new ArrayList<ChoiceInquiry>(other.inquiries.size());
  ...
  public int hashCode() {
    ...
    boolean present_inquiries = true && (isSetInquiries());
    list.add(present_inquiries);
    if (present_inquiries)
      list.add(inquiries);
  ...
  public int compareTo(ChoiceRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetInquiries()).compareTo(other.isSetInquiries());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInquiries()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                ChoiceInquiry _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = new ChoiceInquiry();
                  _elem99.read(iprot);
                  struct.inquiries.add(_elem99);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(2)) {
        {
          ...
          ChoiceInquiry _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new ChoiceInquiry();
            _elem104.read(iprot);
            struct.inquiries.add(_elem104);
          }
        }
        struct.setInquiriesIsSet(true);
      }
