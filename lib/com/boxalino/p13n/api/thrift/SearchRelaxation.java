...
public class SearchRelaxation implements org.apache.thrift.TBase<SearchRelaxation, SearchRelaxation._Fields>, java.io.Serializable, Cloneable, Comparable<SearchRelaxation> {
  ...
  public SearchRelaxation(SearchRelaxation other) {
    if (other.isSetSuggestionsResults()) {
      List<SearchResult> __this__suggestionsResults = new ArrayList<SearchResult>(other.suggestionsResults.size());
    ...
    if (other.isSetSubphrasesResults()) {
      List<SearchResult> __this__subphrasesResults = new ArrayList<SearchResult>(other.subphrasesResults.size());
  ...
  public int hashCode() {
    ...
    boolean present_suggestionsResults = true && (isSetSuggestionsResults());
    list.add(present_suggestionsResults);
    if (present_suggestionsResults)
      list.add(suggestionsResults);

    boolean present_subphrasesResults = true && (isSetSubphrasesResults());
    list.add(present_subphrasesResults);
    if (present_subphrasesResults)
      list.add(subphrasesResults);
  ...
  public int compareTo(SearchRelaxation other) {
    ...
    lastComparison = Boolean.valueOf(isSetSuggestionsResults()).compareTo(other.isSetSuggestionsResults());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetSubphrasesResults()).compareTo(other.isSetSubphrasesResults());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                SearchResult _elem165;
                for (int _i166 = 0; _i166 < _list164.size; ++_i166)
                {
                  _elem165 = new SearchResult();
                  _elem165.read(iprot);
                  struct.suggestionsResults.add(_elem165);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                SearchResult _elem168;
                for (int _i169 = 0; _i169 < _list167.size; ++_i169)
                {
                  _elem168 = new SearchResult();
                  _elem168.read(iprot);
                  struct.subphrasesResults.add(_elem168);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          SearchResult _elem175;
          for (int _i176 = 0; _i176 < _list174.size; ++_i176)
          {
            _elem175 = new SearchResult();
            _elem175.read(iprot);
            struct.suggestionsResults.add(_elem175);
          }
        }
        struct.setSuggestionsResultsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          SearchResult _elem178;
          for (int _i179 = 0; _i179 < _list177.size; ++_i179)
          {
            _elem178 = new SearchResult();
            _elem178.read(iprot);
            struct.subphrasesResults.add(_elem178);
          }
        }
        struct.setSubphrasesResultsIsSet(true);
      }
