...
public class ContextItem implements org.apache.thrift.TBase<ContextItem, ContextItem._Fields>, java.io.Serializable, Cloneable, Comparable<ContextItem> {
  ...
  public int hashCode() {
    ...
    boolean present_contextItemId = true && (isSetContextItemId());
    list.add(present_contextItemId);
    if (present_contextItemId)
      list.add(contextItemId);
  ...
  public int compareTo(ContextItem other) {
    ...
    lastComparison = Boolean.valueOf(isSetContextItemId()).compareTo(other.isSetContextItemId());
    if (lastComparison != 0) {
      return lastComparison;
    }
