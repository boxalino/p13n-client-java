...
public class FacetRequest implements org.apache.thrift.TBase<FacetRequest, FacetRequest._Fields>, java.io.Serializable, Cloneable, Comparable<FacetRequest> {
  ...
  public FacetRequest(FacetRequest other) {
    ...
    if (other.isSetSelectedValues()) {
      List<FacetValue> __this__selectedValues = new ArrayList<FacetValue>(other.selectedValues.size());
  ...
  public int hashCode() {
    ...
    boolean present_numerical = true;
    list.add(present_numerical);
    ...
    boolean present_minPopulation = true;
    list.add(present_minPopulation);
    if (present_minPopulation)
      list.add(minPopulation);

    boolean present_dateRangeGap = true && (isSetDateRangeGap());
    list.add(present_dateRangeGap);
    if (present_dateRangeGap)
      list.add(dateRangeGap.getValue());

    boolean present_sortOrder = true && (isSetSortOrder());
    list.add(present_sortOrder);
    if (present_sortOrder)
      list.add(sortOrder.getValue());

    boolean present_sortAscending = true;
    list.add(present_sortAscending);
    if (present_sortAscending)
      list.add(sortAscending);
    ...
    boolean present_andSelectedValues = true;
    list.add(present_andSelectedValues);
    if (present_andSelectedValues)
      list.add(andSelectedValues);
  ...
  public int compareTo(FacetRequest other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumerical()).compareTo(other.isSetNumerical());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumerical()) {
    ...
    lastComparison = Boolean.valueOf(isSetMinPopulation()).compareTo(other.isSetMinPopulation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDateRangeGap()).compareTo(other.isSetDateRangeGap());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSortAscending()).compareTo(other.isSetSortAscending());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetAndSelectedValues()).compareTo(other.isSetAndSelectedValues());
    if (lastComparison != 0) {
      return lastComparison;
    }
      ...
      if (incoming.get(8)) {
        {
          ...
          {
            _elem30 = new FacetValue();
            _elem30.read(iprot);
            struct.selectedValues.add(_elem30);
          }
        }
        struct.setSelectedValuesIsSet(true);
      }
