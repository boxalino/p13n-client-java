            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                {
                  _elem189 = new Variant();
                  _elem189.read(iprot);
                  struct.variants.add(_elem189);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChoiceResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.variants != null) {
        oprot.writeFieldBegin(VARIANTS_FIELD_DESC);
        {
          ...
          for (Variant _iter191 : struct.variants)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.variants = new ArrayList<Variant>(_list193.size);
          Variant _elem194;
          for (int _i195 = 0; _i195 < _list193.size; ++_i195)
          {
            _elem194 = new Variant();
            _elem194.read(iprot);
