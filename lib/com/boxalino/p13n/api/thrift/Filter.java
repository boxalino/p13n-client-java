...
public class Filter implements org.apache.thrift.TBase<Filter, Filter._Fields>, java.io.Serializable, Cloneable, Comparable<Filter> {
  ...
  public Filter(Filter other) {
    ...
    if (other.isSetHierarchy()) {
      List<String> __this__hierarchy = new ArrayList<String>(other.hierarchy);
  ...
  public int hashCode() {
    ...
    boolean present_negative = true;
    list.add(present_negative);
    if (present_negative)
      list.add(negative);
    ...
    boolean present_hierarchyId = true && (isSetHierarchyId());
    list.add(present_hierarchyId);
    if (present_hierarchyId)
      list.add(hierarchyId);

    boolean present_hierarchy = true && (isSetHierarchy());
    list.add(present_hierarchy);
    if (present_hierarchy)
      list.add(hierarchy);

    boolean present_rangeFrom = true && (isSetRangeFrom());
    list.add(present_rangeFrom);
    if (present_rangeFrom)
      list.add(rangeFrom);

    boolean present_rangeFromInclusive = true;
    list.add(present_rangeFromInclusive);
    if (present_rangeFromInclusive)
      list.add(rangeFromInclusive);

    boolean present_rangeTo = true && (isSetRangeTo());
    list.add(present_rangeTo);
    if (present_rangeTo)
      list.add(rangeTo);

    boolean present_rangeToInclusive = true;
    list.add(present_rangeToInclusive);
    if (present_rangeToInclusive)
      list.add(rangeToInclusive);
  ...
  public int compareTo(Filter other) {
    ...
    lastComparison = Boolean.valueOf(isSetNegative()).compareTo(other.isSetNegative());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.valueOf(isSetHierarchyId()).compareTo(other.isSetHierarchyId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHierarchyId()) {
    ...
    lastComparison = Boolean.valueOf(isSetHierarchy()).compareTo(other.isSetHierarchy());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHierarchy()) {
    ...
    lastComparison = Boolean.valueOf(isSetRangeFrom()).compareTo(other.isSetRangeFrom());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRangeFrom()) {
    ...
    lastComparison = Boolean.valueOf(isSetRangeFromInclusive()).compareTo(other.isSetRangeFromInclusive());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetRangeTo()).compareTo(other.isSetRangeTo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRangeTo()) {
    ...
    lastComparison = Boolean.valueOf(isSetRangeToInclusive()).compareTo(other.isSetRangeToInclusive());
    if (lastComparison != 0) {
      return lastComparison;
    }
