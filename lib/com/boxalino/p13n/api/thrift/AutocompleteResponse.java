...
public class AutocompleteResponse implements org.apache.thrift.TBase<AutocompleteResponse, AutocompleteResponse._Fields>, java.io.Serializable, Cloneable, Comparable<AutocompleteResponse> {
  ...
  public AutocompleteResponse(AutocompleteResponse other) {
    if (other.isSetHits()) {
      List<AutocompleteHit> __this__hits = new ArrayList<AutocompleteHit>(other.hits.size());
  ...
  public int hashCode() {
    ...
    boolean present_prefixSearchResult = true && (isSetPrefixSearchResult());
    list.add(present_prefixSearchResult);
    if (present_prefixSearchResult)
      list.add(prefixSearchResult);
  ...
  public int compareTo(AutocompleteResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetPrefixSearchResult()).compareTo(other.isSetPrefixSearchResult());
    if (lastComparison != 0) {
      return lastComparison;
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.hits = new ArrayList<AutocompleteHit>(_list244.size);
                AutocompleteHit _elem245;
                for (int _i246 = 0; _i246 < _list244.size; ++_i246)
                {
                  _elem245 = new AutocompleteHit();
                  _elem245.read(iprot);
                  struct.hits.add(_elem245);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AutocompleteResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.hits != null) {
        oprot.writeFieldBegin(HITS_FIELD_DESC);
        {
          ...
          for (AutocompleteHit _iter247 : struct.hits)
          {
      ...
      if (struct.isSetHits()) {
        {
          ...
          for (AutocompleteHit _iter248 : struct.hits)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.hits = new ArrayList<AutocompleteHit>(_list249.size);
          AutocompleteHit _elem250;
          for (int _i251 = 0; _i251 < _list249.size; ++_i251)
          {
            _elem250 = new AutocompleteHit();
            _elem250.read(iprot);
            struct.hits.add(_elem250);
          }
        }
        struct.setHitsIsSet(true);
      }
