            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.variantIds = new HashMap<String,Integer>(2*_map244.size);
                for (int _i245 = 0; _i245 < _map244.size; ++_i245)
                {
                  ...
                  struct.variantIds.put(_key246, _val247);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChoiceUpdateRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.variantIds != null) {
        oprot.writeFieldBegin(VARIANT_IDS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter248 : struct.variantIds.entrySet())
          {
      ...
      if (struct.isSetVariantIds()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter249 : struct.variantIds.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.variantIds = new HashMap<String,Integer>(2*_map250.size);
          for (int _i251 = 0; _i251 < _map250.size; ++_i251)
          {
            ...
            struct.variantIds.put(_key252, _val253);
          }
        }
        struct.setVariantIdsIsSet(true);
      }
