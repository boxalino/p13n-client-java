...
public class AutocompleteHit implements org.apache.thrift.TBase<AutocompleteHit, AutocompleteHit._Fields>, java.io.Serializable, Cloneable, Comparable<AutocompleteHit> {
  ...
  public int hashCode() {
    ...
    boolean present_suggestion = true && (isSetSuggestion());
    list.add(present_suggestion);
    if (present_suggestion)
      list.add(suggestion);

    boolean present_highlighted = true && (isSetHighlighted());
    list.add(present_highlighted);
    if (present_highlighted)
  ...
  public int compareTo(AutocompleteHit other) {
    ...
    lastComparison = Boolean.valueOf(isSetHighlighted()).compareTo(other.isSetHighlighted());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHighlighted()) {
