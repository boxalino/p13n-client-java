...
public class BatchChoiceResponse implements org.apache.thrift.TBase<BatchChoiceResponse, BatchChoiceResponse._Fields>, java.io.Serializable, Cloneable, Comparable<BatchChoiceResponse> {
  ...
  public int hashCode() {
    ...
    boolean present_selectedVariants = true && (isSetSelectedVariants());
    list.add(present_selectedVariants);
    if (present_selectedVariants)
      list.add(selectedVariants);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.variants = new ArrayList<Variant>(_list212.size);
                Variant _elem213;
                for (int _i214 = 0; _i214 < _list212.size; ++_i214)
                {
                  _elem213 = new Variant();
                  _elem213.read(iprot);
                  struct.variants.add(_elem213);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.selectedVariants = new ArrayList<List<Variant>>(_list215.size);
                List<Variant> _elem216;
                for (int _i217 = 0; _i217 < _list215.size; ++_i217)
                {
                  {
                    org.apache.thrift.protocol.TList _list218 = iprot.readListBegin();
                    _elem216 = new ArrayList<Variant>(_list218.size);
                    Variant _elem219;
                    for (int _i220 = 0; _i220 < _list218.size; ++_i220)
                    {
                      _elem219 = new Variant();
                      _elem219.read(iprot);
                      _elem216.add(_elem219);
                    }
                    iprot.readListEnd();
                  }
                  struct.selectedVariants.add(_elem216);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, BatchChoiceResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.variants != null) {
        oprot.writeFieldBegin(VARIANTS_FIELD_DESC);
        {
          ...
          for (Variant _iter221 : struct.variants)
          {
      ...
      if (struct.selectedVariants != null) {
        oprot.writeFieldBegin(SELECTED_VARIANTS_FIELD_DESC);
        {
          ...
          for (List<Variant> _iter222 : struct.selectedVariants)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter222.size()));
              for (Variant _iter223 : _iter222)
              {
  ...
  private static class BatchChoiceResponseTupleScheme extends TupleScheme<BatchChoiceResponse> {
      ...
      if (struct.isSetVariants()) {
        {
          ...
          for (Variant _iter224 : struct.variants)
          {
      ...
      if (struct.isSetSelectedVariants()) {
        {
          ...
          for (List<Variant> _iter225 : struct.selectedVariants)
          {
            {
              oprot.writeI32(_iter225.size());
              for (Variant _iter226 : _iter225)
              {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, BatchChoiceResponse struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.variants = new ArrayList<Variant>(_list227.size);
          Variant _elem228;
          for (int _i229 = 0; _i229 < _list227.size; ++_i229)
          {
            _elem228 = new Variant();
            _elem228.read(iprot);
            struct.variants.add(_elem228);
          }
        }
        struct.setVariantsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list230 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.LIST, iprot.readI32());
          struct.selectedVariants = new ArrayList<List<Variant>>(_list230.size);
          List<Variant> _elem231;
          ...
          {
            {
              ...
              _elem231 = new ArrayList<Variant>(_list233.size);
              Variant _elem234;
              for (int _i235 = 0; _i235 < _list233.size; ++_i235)
              {
                _elem234 = new Variant();
                _elem234.read(iprot);
                _elem231.add(_elem234);
              }
            }
            struct.selectedVariants.add(_elem231);
          }
        }
        struct.setSelectedVariantsIsSet(true);
      }
